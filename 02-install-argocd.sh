...
pe "./argocd proj add-source production https://github.com/vmSalem/tanzu-demo-applications"
pe "./argocd proj add-source production https://github.com/vmSalem/tanzu-demo-manifest"
